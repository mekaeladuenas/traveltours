<section class="page-section bg-white" id="home">
	<div class="container">
		<h2 class="text-center">Travel & Package</h2>
	<div class="d-flex w-100 justify-content-center">
		<hr class="border-secondary" style="border:3px solid" width="30%">
	</div>
	<div class="w-100">
		<?php
		...
		?>
			<div class="card d-flex w-100 rounded-0 mb-3 package-item">
				...
				<div class="w-100 d-flex justify-content-between">
					<span class="rounded-0 btn btn-flat btn-sm btn-danger"><i class="fa fa-tag"></i> <?php echo number_format($row['cost']) ?></span>
					<a href="./?page=view_package&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-secondary">View Package <i class=""></i></a>
				</div>
				</div>
			</div>
		<?php endwhile; ?>
