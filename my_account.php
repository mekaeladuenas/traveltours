...
<section class="page-section">
    ...
    <div class="w-100 justify-content-between d-flex">
        <h4><b>My Booked Packages</b></h4>
        <a href="./?page=edit_account" class="btn btn btn-secondary btn-flat"><div class="fa fa-user"></div> My Account</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <?php elseif($row['status'] == 1): ?>
                                <span class="badge badge-seconday">Confirmed</span>
