<section class="page-section">
    ...
    <div class="w-100 justify-content-between d-flex">
        <h4><b>Update Account Information</b></h4>
        <a href="./?page=my_account" class="btn btn btn-secondary btn-flat"><div class="fa fa-angle-left"></div> Back to Booking List</a>
    </div>
        ...
        <div class="col-md-6">
            ...
            <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                ...
                <div class="form-group d-flex justify-content-end">
                    <button class="btn btn-secondary btn-flat">Update</button>
                </div>
            </form>
        </div>
    </div>
